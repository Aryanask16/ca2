...
const Component2: NextPage<ComponentType> = ({
  className = "",
  directTaxation,
  minimizeTaxStressMaximize,
}) => { const imageUrl =
  "https://img.freepik.com/free-photo/guy-shows-document-girl-group-young-freelancers-office-have-conversation-working_146671-13569.jpg";
  return (
